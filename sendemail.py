...
def sendEmail(From, to, subject, message, mailservice, password):
    ...
    with smtplib.SMTP(host=mail, port=587) as smtp: #host could be any email service and port = 587 is the standart for the smtp protocol
